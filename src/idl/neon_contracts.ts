export type NeonContracts = {
  ...
  "address": "ARcy8Hgks4bfNoYrrdCunrHbvE1dR8kiFHBCRu1Gw6Gi",
  "metadata": {
    "name": "neon_contracts",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "Ranked Racing Smart Contract"
  }
};

export const IDL: NeonContracts = {
  "version": "0.1.0",
  "name": "neon_contracts",
  "instructions": [
    {
